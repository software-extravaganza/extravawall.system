...
namespace ExtravaWallSetup.Stages.InstallCheckSystem {
    public class InstallCheckSystemStep : StepBase {
        ...
        public abstract record BasePackage(string Name, Ver Version) : IPackage {
            public abstract bool ShouldMarkToInstall { get; }

        }
        public record PackageDependency(string Name, Ver Version) : BasePackage(Name, Version) {
            public override bool ShouldMarkToInstall => false;
        }

        public record PackageNeeded(string Name, Ver Version, params IPackage[] Dependencies) : BasePackage(Name, Version) {
        ...
        private async Task<bool> SetupRequiredPackages(ITextOutput writer) {
            ...
            //     new PackageNeeded("curl", new Ver(7, 74),
            //         new PackageDependency("chafa", new Ver(1, 6))
            //     ),
            //     new PackageNeeded("neofetch", new Ver(7, 1),
            //        new PackageDependency("libmagickwand-6.q16-6", new Ver(6, 9)),
            //         new PackageDependency("ghostscript", new Ver(9, 53)),
            //         new PackageDependency("libgs9", new Ver(9, 53)),
            //         new PackageDependency("libfontconfig1", new Ver(2, 13)),
            //         new PackageDependency("fontconfig-config", new Ver(2, 13)),
            //         new PackageDependency("fonts-dejavu-core", new Ver(2, 37)),
            //         new PackageDependency("fonts-droid-fallback", new Ver(6, 0)),
            //         new PackageDependency("fonts-noto-mono", new Ver(20201225)),
            //         new PackageDependency("libgs9-common", new Ver(9, 53)),
            //         new PackageDependency("fonts-urw-base35", new Ver(20200910)),
            //         new PackageDependency("gsfonts", new Ver(8, 11)),
            //         new PackageDependency("imagemagick-6-common", new Ver(1, 11)),
            //         new PackageDependency("libheif1", new Ver(1, 11)),
            //         new PackageDependency("libaom0", new Ver(1)),
            //         new PackageDependency("libcups2", new Ver(2, 3)),
            //         new PackageDependency("libavahi-client3", new Ver(0, 8)),
            //         new PackageDependency("libavahi-common3", new Ver(0, 8)),
            //         new PackageDependency("libavahi-common-data", new Ver(0, 8)),
            //         new PackageDependency("libcurl4", new Ver(7, 74)),
            //         new PackageDependency("libfreetype6", new Ver(2, 10)),
            //         new PackageDependency("libbrotli1", new Ver(1)),
            //         new PackageDependency("libchafa0", new Ver(1, 6)),
            //         new PackageDependency("libdav1d4", new Ver(0, 7)),
            //         new PackageDependency("libde265-0", new Ver(1, 0)),
            //         new PackageDependency("libtiff5", new Ver(4, 2)),
            //         new PackageDependency("libdeflate0", new Ver(1, 7)),
            //         new PackageDependency("libfftw3-double3", new Ver(3, 3)),
            //         new PackageDependency("shared-mime-info", new Ver(2, 0)),
            //         new PackageDependency("liblqr-1-0", new Ver(0, 4)),
            //         new PackageDependency("libglib2.0-0", new Ver(2, 66)),
            //         new PackageDependency("libglib2.0-data", new Ver(2, 66)),
            //         new PackageDependency("libgomp1", new Ver(10, 2)),
            //         new PackageDependency("libidn11", new Ver(1, 33)),
            //         new PackageDependency("libijs-0.35", new Ver(0, 35)),
            //         new PackageDependency("libjbig0", new Ver(2, 1)),
            //         new PackageDependency("libjbig2dec0", new Ver(0, 19)),
            //         new PackageDependency("libjpeg62-turbo", new Ver(2, 0)),
            //         new PackageDependency("liblcms2-2", new Ver(2, 12)),
            //         new PackageDependency("libldap-2.4-2", new Ver(2, 4)),
            //         new PackageDependency("libldap-common", new Ver(2, 4)),
            //         new PackageDependency("libnghttp2-14", new Ver(1, 43)),
            //         new PackageDependency("libx265-192", new Ver(3, 4)),
            //         new PackageDependency("libnuma1", new Ver(2, 0)),
            //         new PackageDependency("libopenjp2-7", new Ver(2, 4)),
            //         new PackageDependency("libpaper-utils", new Ver(1, 1)),
            //         new PackageDependency("libpaper1", new Ver(1, 1)),
            //         new PackageDependency("libpng16-16", new Ver(1, 6)),
            //         new PackageDependency("librtmp1", new Ver(2, 4)),
            //         new PackageDependency("libsasl2-2", new Ver(2, 1)),
            //         new PackageDependency("libsasl2-modules", new Ver(2, 1)),
            //         new PackageDependency("libsasl2-modules-db", new Ver(2, 1)),
            //         new PackageDependency("libssh2-1", new Ver(1, 9)),
            //         new PackageDependency("libwebpmux3", new Ver(0, 6)),
            //         new PackageDependency("libwebp6", new Ver(0, 6)),
            //         new PackageDependency("libxml2", new Ver(2, 9)),
            //         new PackageDependency("poppler-data", new Ver(0, 4)),
            //         new PackageDependency("xdg-user-dirs", new Ver(0, 17))
            //     ),
            //     new PackageNeeded("aspnetcore-runtime-7.0", new Ver(7),
            //         new PackageNeeded("dotnet-runtime-7.0", new Ver(7),
            //             new PackageDependency("dotnet-hostfxr-7.0", new Ver(7)),
            //             new PackageDependency("libicu67:amd64", new Ver(67)),
            //             new PackageDependency("dotnet-runtime-deps-7.0", new Ver(7)),
            //             new PackageDependency("dotnet-host", new Ver(7))
            //         )
            //     ),
            //     new PackageNeeded("postgresql-13", new Ver(13)),
            //     new PackageNeeded("postgresql-client-13", new Ver(13))
            // );
