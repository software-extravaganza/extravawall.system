...
#define SLOT_HEADER_STATUS_OFFSET 0
#define SLOT_HEADER_ID_OFFSET (SLOT_HEADER_STATUS_OFFSET + SLOT_HEADER_STATUS_SIZE)
#define SLOT_HEADER_TOTAL_DATA_SIZE_OFFSET (SLOT_HEADER_ID_OFFSET + SLOT_HEADER_ID_SIZE)
#define SLOT_HEADER_CURRENT_DATA_SIZE_OFFSET (SLOT_HEADER_TOTAL_DATA_SIZE_OFFSET + SLOT_HEADER_TOTAL_DATA_SIZE_SIZE)
#define SLOT_HEADER_SEQUENCE_NUMBER_OFFSET (SLOT_HEADER_CURRENT_DATA_SIZE_OFFSET + SLOT_HEADER_CURRENT_DATA_SIZE_SIZE)
#define SLOT_HEADER_CLEARANCE_START_INDEX_OFFSET (SLOT_HEADER_SEQUENCE_NUMBER_OFFSET + SLOT_HEADER_SEQUENCE_NUMBER_SIZE)
#define SLOT_HEADER_CLEARANCE_END_INDEX_OFFSET (SLOT_HEADER_CLEARANCE_START_INDEX_OFFSET + SLOT_HEADER_CLEARANCE_START_INDEX_SIZE)
#define SLOT_HEADER_SIZE (SLOT_HEADER_CLEARANCE_END_INDEX_OFFSET + SLOT_HEADER_CLEARANCE_END_INDEX_SIZE)
...
typedef enum {
    ...
    Full = 2,
    Terminating = 3
} __attribute__((packed)) RingBufferStatus;
